...
| preferred_category | enum(IT, Sales&Marketing, BPO, BackOffice, Permanent, Bulk, Driver, FieldStaff) | explicit column — fast filter |
| driving_license_number | text, nullable | required if preferred_category=Driver; e.g. "DL-1420110012345" |
| dl_category | enum(LMV, HMV, Commercial, TwoWheeler), nullable | driver-specific classification |
| dl_expiry_date | date, nullable | |
| vehicle_types | text, nullable | JSON array or comma-separated string, e.g. "Manual, Automatic, Sedan, SUV" |
| police_verification_status | enum(NotSubmitted, Pending, Verified), default NotSubmitted | badge status for driver/staffing confidence |
| police_verification_doc_url | text, nullable | Cloudflare R2 link to PCC document |
| is_blacklisted | bool, default false | internal fraud/misconduct flag (Admin-only view & control) |
| blacklist_reason | text, nullable | internal audit note explaining misconduct |
